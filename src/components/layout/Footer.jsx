    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Shop Information */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary-400">Shop Information</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/stores" className="hover:text-primary-400 transition-colors">Store Locations</Link></li>
            </ul>
          </div>

          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary-400">Customer Service</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/shipping" className="hover:text-primary-400 transition-colors">Shipping Information</Link></li>
              <li><Link to="/track-order" className="hover:text-primary-400 transition-colors">Track Your Order</Link></li>
              <li><Link to="/warranty" className="hover:text-primary-400 transition-colors">Product Warranty</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/account" className="hover:text-primary-400 transition-colors">My Profile</Link></li>
              ...
              <li><Link to="/notifications" className="hover:text-primary-400 transition-colors">My Notifications</Link></li>
              <li><Link to="/settings" className="hover:text-primary-400 transition-colors">Account Settings</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <h3 className="text-lg font-bold mb-4 text-center text-primary-400">Payment Methods</h3>
