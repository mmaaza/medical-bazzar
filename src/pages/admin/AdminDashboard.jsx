...
const AdminDashboard = () => {
  ...
  const formatCurrency = (value) => `रु${value.toLocaleString()}`;
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-admin-slate-200 dark:border-admin-slate-700">
            ...
            <div>
              ...
              <p className="mt-2 flex items-baseline gap-x-2">
                ...
                <span className="text-sm text-admin-slate-500">रु9,800</span>
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-admin-slate-600 dark:text-admin-slate-400">Projected Q2</p>
              <p className="mt-2 flex items-baseline gap-x-2">
                <span className="text-lg font-semibold text-admin-slate-900 dark:text-admin-slate-100">रु32,400</span>
          ...
          <div className="mt-6 pt-6 border-t border-admin-slate-200 dark:border-admin-slate-700">
            ...
            <div className="grid grid-cols-4 gap-6 mb-6">
              ...
              <div>
                ...
                <div className="mt-2 flex items-baseline gap-2">
                  <p className="text-2xl font-semibold text-admin-slate-900 dark:text-admin-slate-100">रु785</p>
