...
const CategoriesPage = () => {
  // Sample category data - would come from your backend in production
  const [categories] = useState([
    {
      id: 1,
      name: 'Hospital Equipment',
      slug: 'hospital-equipment',
      description: 'Medical equipment used in hospitals',
      productsCount: 150,
      status: 'active',
      image: 'https://placehold.co/300x300?text=Hospital'
    },
    {
      id: 2,
      name: 'Laboratory Supplies',
      slug: 'laboratory-supplies',
      description: 'Supplies for medical laboratories',
      productsCount: 75,
      status: 'active',
      image: 'https://placehold.co/300x300?text=Lab'
    },
    {
      id: 3,
      ...
      productsCount: 200,
      status: 'active',
      image: 'https://placehold.co/300x300?text=Diagnostic'
    }
  ]);
      ...
      <div className="bg-white shadow-mobile rounded-lg p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="sm:w-48">
            <select className="block w-full rounded-lg border-gray-300 py-2 pl-3 pr-10 text-sm focus:border-primary-500 focus:ring-primary-500">
