        ...
        <div className="bg-white dark:bg-admin-slate-800 rounded-xl p-6 shadow-sm">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-admin-ucla-100 dark:bg-admin-ucla-900/30">
              <svg className="w-6 h-6 text-admin-ucla-600 dark:text-admin-ucla-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-2xl font-bold text-admin-ucla-600 dark:text-admin-ucla-400">
                {posts.length}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-admin-slate-800 rounded-xl p-6 shadow-sm">
          <div className="flex items-center">
            <div className="p-3 rounded-full bg-admin-cerulean-100 dark:bg-admin-cerulean-900/30">
              <svg className="w-6 h-6 text-admin-cerulean-600 dark:text-admin-cerulean-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="ml-4">
              ...
              <p className="mt-1 text-2xl font-bold text-admin-cerulean-600 dark:text-admin-cerulean-400">
                0
              </p>
            </div>
          </div>
